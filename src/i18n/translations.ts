...
export const translations: Record<Lang, Dict> = {
  en: {
    ...
    projects: {
      ...
      title: 'My',
      titleEm: 'Projects',
      hint: 'Hover a card to pull it out · click to focus · Esc / click outside to close',
      shuffle: '▷ press me',
    ...
    dialog: {
      ...
      github: {
        label: 'GitHub',
        flavor: '* Take a peek at my code & projects.',
  ...
  pt: {
    ...
    projects: {
      ...
      title: 'Meus',
      titleEm: 'Projetos',
      hint: 'Passe o mouse para destacar · clique para focar · Esc / clique fora para fechar',
      shuffle: '▷ me aperta',
      shuffleAria: 'Embaralhar o baralho',
      view: (name) => `Ver ${name}`,
      code: '⌥ Código',
    },
    contact: {
    ...
    dialog: {
      defaultText: '* Oi! Obrigada por dar uma passada.\n* O que você quer fazer?',
      ...
      github: {
        label: 'GitHub',
        flavor: '* Dá uma espiada no meu código & projetos.',
